...
class ProductType(models.Model):
    ...
    """
    name = models.CharField(verbose_name=_("Product Name"), help_text=_("Required"), max_length=520, unique=True)
    is_active = models.BooleanField(default=True)
...
class ProductSpecification(models.Model):
    ...
    name = models.CharField(verbose_name=_("Name"), help_text=_("Required"), max_length=520)
    class Meta:
...
class Product(models.Model):
    ...
    is_active = models.BooleanField(
        ...
        help_text=_("Change product visiblity"),
        default=True,
    )
    created_at = models.DateTimeField(_("Created at"), auto_now_add=True, editable=False)
    updated_at = models.DateTimeField(_("Updated at"), auto_now= True)
    users_wishlist = models.ManyToManyField(settings.AUTH_USER_MODEL, related_name="user_wishlist", blank=True)
    save_for_later = models.ManyToManyField(settings.AUTH_USER_MODEL, related_name="user_save_for_later", blank=True)
...
def calculate_discount_percentage(sender, instance, *args, **kwargs):
        # Calculate discount_percentage before saving
        if instance.regular_price and instance.discount_price:
            discount_percentage = ((instance.regular_price - instance.discount_price) / instance.regular_price) * 100
            instance.discount_percentage = round(discount_percentage, 2)
        else:
            instance.discount_percentage = 0.0
    

class ProductSpecifiactionValue(models.Model):
    """_summary_
    ...
    value = models.CharField(
        ...
        help_text=_("Product specifiaction value (maximum of 520 words)"),
        max_length=520,
    )
